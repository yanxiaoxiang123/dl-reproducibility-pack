...
5. **Create Project Structure** - Scaffold missing directories
6. **Generate Configuration** - Create `configs/default.yaml`
7. **Generate Documentation** - Create publication-ready README and CITATION.cff
...
| `nn.utils.rnn.pad_sequence` | Pad variable-length sequences |
